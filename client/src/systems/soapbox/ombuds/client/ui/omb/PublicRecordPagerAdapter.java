 ...
 */
public class PublicRecordPagerAdapter extends FragmentPagerAdapter {
    ...
    public PublicRecordPagerAdapter(Context context, FragmentManager fm) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        switch (position) {
            case ALL_POS:
                return PublicRecordAllFragment.newInstance();
            case WATCHING_POS:
                return PublicRecordWatchingFragment.newInstance();
            case PROFILE_POS:
